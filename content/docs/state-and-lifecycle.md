...
Trong chương này, chúng ta sẽ học làm thế thế nào để tạo thành phần `Clock` có thể tái sử dụng và đóng gói. Nó sẽ tự đặt hẹn giờ và cập nhập mỗi giây
...
Lý tưởng nhất là chúng ta làm điều này một lần duy nhất và có một `Clock` tự cập nhập:
